    ...
    <div class="row">
        <div class="col-12">
            <form class="text-left mx-auto card p-4 w-100 p-2 text-light needs-validation formsLogin" novalidate
                  action="enviarCodigo" method="POST" autocomplete="off">
                <c:choose>
                ...
                <label for="correo" class="text-left ml-0  fw-bold mb-2">Ingresa tu correo electrónico</label>
                ...
                <a class="btn btn-md btn-light btn-block mt-3 fw-bold sysbutton" href="ingreso">Cancelar</a>
            </form>
        </div>
