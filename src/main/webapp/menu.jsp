        ...
        <div class="row icon-boxes">
            ...
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mt-5 mb-lg-0" data-aos="zoom-in"
                ...
                <div class="icon-box">
                    ...
                    <h4 class="title"><a href="#">Visualizar Pagos</a></h4>
                    <p class="description">
            ...
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mt-5 mb-lg-0" data-aos="zoom-in"
                ...
                <div class="icon-box">
                    ...
                    <h4 class="title"><a href="#">Visualizar autos</a></h4>
                    <p class="description">
            ...
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mt-5 mb-lg-0" data-aos="zoom-in"
                ...
                <div class="icon-box">
                    ...
                    <h4 class="title"><a href="#">Historial de Revisión</a></h4>
                    <p class="description">
            ...
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mt-5 mb-lg-0" data-aos="zoom-in"
                ...
                <div class="icon-box">
                    ...
                    <h4 class="title"><a href="gestionCatalogo">Gestionar Catálogo</a></h4>
                    <p class="description">
                        Esta opción del menú le permite visualizar productos y servicios disponibles.
                    </p>
                </div>
            </div>
